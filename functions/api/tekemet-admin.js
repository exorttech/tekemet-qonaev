import { getAnalyticsV2 } from "../_lib/tekemet-analytics.js";
...
function packDishAnalyticsReferrer(payload) {
  ...
  const encoded = encodeBase64Url(textEncoder.encode(JSON.stringify({ dishId, contentKey, title, section, price, currency, durationMs, referrer })));
  return `dish:${encoded}`;
}
